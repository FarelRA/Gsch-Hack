...
public class C0531m extends ImageView {

    /* renamed from: b */
    public final C0499d f2016b;

    /* renamed from: c */
    public final C0528l f2017c;

    public C0531m(Context context) {
        this(context, null, 0);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0531m(Context context, AttributeSet attributeSet, int i) {
    ...
    public final void drawableStateChanged() {
        ...
        C0499d c0499d = this.f2016b;
        if (c0499d != null) {
            c0499d.m632a();
        }
        C0528l c0528l = this.f2017c;
        if (c0528l != null) {
            c0528l.m596a();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        if ((!(this.f2017c.f1994a.getBackground() instanceof RippleDrawable)) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
